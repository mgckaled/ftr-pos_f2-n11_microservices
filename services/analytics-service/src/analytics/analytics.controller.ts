...
export class AnalyticsController {
	...
	@Get('daily-summary')
	async getDailySummary(@Query('startDate') startDate: string, @Query('endDate') endDate: string) {
		const query = new GetDailySummaryQuery(new Date(startDate), new Date(endDate))

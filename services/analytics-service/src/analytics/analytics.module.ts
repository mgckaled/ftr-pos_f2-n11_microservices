...
const EventHandlers = [OrderCreatedHandler, OrderConfirmedHandler, OrderCancelledHandler]

const QueryHandlers = [GetDailySummaryHandler, GetOrdersAnalyticsHandler]

@Module({
	imports: [
		CqrsModule,
		TypeOrmModule.forFeature([OrdersAnalyticsView, DailySalesSummary, ProcessedEvent]),
		KafkaModule,
	],
	controllers: [AnalyticsController],
	providers: [...EventHandlers, ...QueryHandlers, OrderEventsConsumer],
})
